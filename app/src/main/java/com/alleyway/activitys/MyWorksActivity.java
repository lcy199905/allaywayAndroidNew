...
public class MyWorksActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        work_list_item=findViewById(R.id.my_work_list_item);
        try {
...
//        sp.edit().commit();
        Intent intent = new Intent(MyWorksActivity.this,DetailsActivity.class);
    ...
    class MyAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            if (view==null) {
                // 加载item的布局,得到View对象
                view=View.inflate(MyWorksActivity.this,R.layout.home_list,null);
            }
            // 根据下标参数设置对应的数据
            // 得到当前行的数据对象
            ...
            // 设置数据
            Glide.with(MyWorksActivity.this).load(headUrl +work.getUserHead()).into(homeUserHeadd);
            ...
            Glide.with(MyWorksActivity.this).load(workUrl+image.toString()).into(homeWorkImage);
